...
class ImageAdapter (private  val mContent : Context):BaseAdapter()
{
    val am:AssetManager
    ...
    override fun getView(position: Int, View: View?, viewGroup:  ViewGroup?): View {
        ...
        val v = LayoutInflater.from(mContent).inflate(R.layout.grid_element,null)
    ...
    private fun getPicFromAsset(imageView: ImageView?, assetName: String): Bitmap? {
        ...
        return if (targetW ==0||targetH ==0){
            ...
            BitmapFactory.decodeStream(`is`, Rect(-1,
                -1,-1,-1),bmOptions)
            ...
            //Decode the image file  in to Bitmap sized to fill the view
